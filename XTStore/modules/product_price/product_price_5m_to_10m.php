...
<?php
$id = (int) $_GET['id'];
$list_product = get_list_price_5m_to_10m($id);
                ...
                if ($list_cat) {
                    ...
                    <ul class="list-item clearfix">
                        ...
                        foreach ($list_cat as $cat) {
                            ...
                            <li>
                                <a href="?" title="">Giá 5.000.000đ - 10.000.000đ</a>
                            </li>
                            <?php
                        }
                        ?>
        ...
        <div class="main-content fl-right">
            <div class="section" id="list-product-wp">
                <div class="section-head clearfix">
                    <div class="section-head clearfix">
                        <h3 class="section-title fl-left">Những sản phẩm giá từ 5.000.000Đ - 10.000.000Đ</h3>
