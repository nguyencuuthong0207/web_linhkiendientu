    ...
    <div class="wp-inner">
        ...
        <div class="main-content fl-right">
            <div class="section" id="list-blog-wp" >
                ...
                <div class="section-detail blog-section">
                    <?php
                    if (!empty($list_post)) {
                        ?>
                        <ul class="list-item">
                            ...
                            foreach ($list_post as $item) {
                                ...
                                ?>
                                <li class="clearfix blog-section">
                                    <a href="<?php echo $item['url']; ?>" title="" class="thumb fl-left">
                                        <img src="admin/uploads/<?php echo $item['images']; ?>" alt="" class="img-post">
                                    </a>
                                    <div class="info post-content fl-right">
                                        <a href="<?php echo $item['url']; ?>" title="" class="title post-title"><?php echo $item['post_title']; ?></a>
