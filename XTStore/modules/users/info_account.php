                ...
                <div class="section" id="detail-blog-wp">
                    ...
                    <div class="section-detail">
                        <form action="" id="form-profile" method="post" accept-charset="utf-8">
                            ...
                            <input type="text" value="<?php echo $list_users['fullname'] ?>" name="display_name" id="display_name" disabled="true" class="input-info" /><br>
                            <label for="user_login">Tên đăng nhập</label>
                            <input type="text" value="<?php echo $list_users['username'] ?>" name="user_login" id="display_name" disabled="true" class="input-info"><br>
                            <label for="phone">Số điện thoại</label>
                            <input type="tel" name="user_tel" value="<?php echo $list_users['phone'] ?>" id="user_tel" disabled="true" class="input-info"><br>
                            <label for="email">Email</label>
                            <input type="email" name="user_email" id="user_email" value="<?php echo $list_users['email'] ?>" disabled="true" class="input-info"><br>
                            <label for="user_address">Địa chỉ</label>
                            <input type="text" name="user_address" id="user_address" disabled="true" value="<?php echo $list_users['address'] ?>" class="input-info"><br>
