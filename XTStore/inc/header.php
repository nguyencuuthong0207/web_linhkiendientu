...
<head>
	...
	<script src="https://kit.fontawesome.com/7bd05a3eee.js" crossorigin="anonymous"></script>
	<script src="https://kit.fontawesome.com/f14816e272.js" crossorigin="anonymous"></script>
...
<body>
	<div id="site">
		<div id="container">
			<div id="header-wp" class="header-container">
					...
					<div class="wp-inner">
						<div id="main-menu-wp" class="fl-left">
							<ul id="main-menu" class="clearfix">
								...
								<li>
									<a href="?mod=post&act=blog" title="" class="header-respon-mble">Blog</a>
								</li>
								...
								?>
									<li>
										<a href="?mod=page&act=main" title="" class="header-respon-mble"><?php echo $item['page_title'] ?></a>
									</li>
								<?php
								}
								?>
								<li>
									<a href="?mod=page&act=contact" title="" class="header-respon-mble" >Liên hệ</a>
								</li>
							</ul>
						</div>
						...
						?>
							<div id="user-login" class="dropdown dropdown-extended fl-right">
								<button class="dropdown-toggle clearfix" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
									<h3 id="account" class="fl-right"><i class="fas fa-user user-icon-login"></i> <strong><?php if (is_login()) echo info_user('fullname'); ?></strong></h3>
								</button>
				...
				<div id="head-body" class="clearfix">
					<div class="wp-inner">
						<a href="?page=home" title="" id="logo" class="fl-left img-logo-header"><img class="logo1" src="public/images/logo-main.png" /></a>
						<a href="?page=home" title="" id="logo2" class="fl-left img-logo-header"><img class="logo2" src="public/images/logo-mini.png" /></a>
						<div id="search-wp" class="fl-left">
							<form method="POST" action="?mod=search&act=search_product">
								...
								<button type="submit" name="" class="seach-btn-res"><i class="fas fa-search"></i></button>
							</form>
						</div>
