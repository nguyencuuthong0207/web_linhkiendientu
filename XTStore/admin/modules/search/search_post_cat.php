...
$sql = "select * from post_cat where status != 2 and post_name like N'%$keyword%'";
...
// phân trang
$number_rows = db_num_rows("select * from post_cat where status != 2 and post_name like N'%$keyword%'");
$num_per_page = 3;
$total_row = $number_rows;
$num_page = ceil($total_row / $num_per_page);
$page = isset($_GET['page']) ? (int) $_GET['page'] : 1;
$start = ($page - 1) * $num_per_page;
$list_cat = get_search_post_cat($start, $num_per_page, $keyword);
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    <ul id="list-paging" class="fl-right">
                        <?php
                        echo get_pagging($num_page, $page, "?mod=search&act=search_post_cat&keyword=$keyword");
                        ?>
                    </ul>
                </div>
            </div>
