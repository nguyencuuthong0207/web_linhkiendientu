                ...
                <div class="section-detail">
                    <form id="form-upload-single"  action="" enctype="multipart/form-data" method="post">
                        ...
                        <?php
                            ...
                            ?>
                            <li>
                                <option <?php if (isset($item['cat_id']) && $item['cat_id'] ==  $category['cat_id']) echo "selected='selected'"; ?> value="<?php echo $category['cat_id'] ?>" title=""> <?php echo $category['post_name'] ?> </option>
                            </li>
                            <?php
                            }
                            ?>
