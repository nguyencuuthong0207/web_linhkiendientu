    ...
    <div class="wrap clearfix">
        ...
        <div id="content" class="fl-right">
            ...
            <div class="section" id="detail-page">
                                ...
                                <tbody>
                                    ...
                                    foreach ($list_bill as $bill) {
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="tbody-text"><?php echo $bill['fullname']; ?></h3></span></td>
                                                ...
                                                <span class="tbody-text">
                                                    ...
                                                    if ($bill['status'] == 0) {
                                                        ...
                                                        <?php
                                                         ...
                                                         ?>
                                                        <a href="#" class="btn btn-disabled-bill btn-xs disabled" disabled="true" >Đã xử lý</a>
                                                        <?php
                                                    }
                                                    ?>
                                                </span>
                ...
                <p class="num_rows">Có <?php echo $number_rows; ?> đơn hàng chưa xử lý trong hệ thống</p>
            </div>
