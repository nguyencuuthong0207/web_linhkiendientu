...
<?php
$sql = "SELECT cat_id,cat_name FROM `category` where status = 1";
$result = mysqli_query($conn, $sql);
$list_category = array();
                ...
                <div class="section-detail">
                    <form id="form-upload-single"  action="" enctype="multipart/form-data" method="post">
                        ...
                        <select name="cat_id">
                            ...
                            ?>
                            <li>
                                <option <?php if (isset($item['cat_id']) && $item['cat_id'] ==  $category['cat_id']) echo "selected='selected'"; ?> value="<?php echo $category['cat_id'] ?>" title=""> <?php echo $category['cat_name'] ?> </option>
                            </li>
                            <?php
                            }
                            ?>
