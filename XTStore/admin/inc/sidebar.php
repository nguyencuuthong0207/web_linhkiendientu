<div id="sidebar" class="fl-left">
    <ul id="sidebar-menu">
        ...
        <li class="nav-item">
            <a href="" title="" class="nav-link nav-toggle">
                <span class="far fa-list-alt icon"></span>
        ...
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                <li class="nav-item">
                    <a href="?mod=admin&act=add" title="" class="nav-link">Thêm mới</a>
                </li>
                <li class="nav-item">
                    <a href="?mod=admin&act=info_account"title="" class="nav-link">Danh sách quản trị viên</a>
                </li>
            </ul>
        </li>
    </ul>
